...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white px-6 py-12 text-gray-800 dark:bg-zinc-950 dark:text-white">
      {/* Hero Section */}
      <section className="mx-auto max-w-4xl text-center">
        ...
        <div className="mt-6 flex justify-center gap-4">
          ...
          <a href="https://github.com/BreezeUI-kit/react-breezeui" target="_blank" rel="noopener noreferrer">
            <Button variant="outline" className="flex"><FaGithub className="pt-0.5 mr-1" size={"20px"} /> GitHub</Button>
          </a>
        </div>
      </section>
